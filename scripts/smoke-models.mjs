...
assert(Math.abs(evScope.teams.Chelsea.coverage_percent-5.1724)<0.0001,"Chelsea EV coverage percent smoke failed");
...
assert(evQueueSummary.valued_contributions===33,"EV work queue valued count failed");
...
assert(chelseaLineage.contribution_count===33,"Chelsea EV lineage count failed");
assert(chelseaLineage.derivation_linked_count===33,"Chelsea derivation linkage failed");
